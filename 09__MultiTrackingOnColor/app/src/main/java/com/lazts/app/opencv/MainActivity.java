...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        mScribble = new Mat(height, width, CvType.CV_8UC3);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        OpencvNativeClass.cvtHsv(mRgba.getNativeObjAddr(), mHsv.getNativeObjAddr());
        OpencvNativeClass.cvtThreshold(mHsv.getNativeObjAddr(), mThreshold.getNativeObjAddr());
        OpencvNativeClass.tracking(mThreshold.getNativeObjAddr(), mScribble.getNativeObjAddr(), mRgba.getNativeObjAddr());
